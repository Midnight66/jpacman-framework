...
public interface CollisionMap {
	 ...
	 * @param collider The unit that causes the collision by occupying a square with
	 *            another unit already on it.
	 * @param collidee The unit that is already on the square that is being invaded.
	 */
